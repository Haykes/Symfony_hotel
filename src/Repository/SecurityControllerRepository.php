 ...
 */
class SecurityControllerRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function save(SecurityController $entity, bool $flush = false): void
    {
    ...
    {
        if (!$user instanceof SecurityController) {
